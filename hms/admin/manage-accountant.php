...
if(strlen($_SESSION['id']==0)) {
 header('location:logout.php');
	...
	if(isset($_GET['del']))
	{
		$Accountantid=$_GET['id'];
			mysqli_query($con,"delete from accountant_log where id ='$Accountantid'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin || Manage Accountant</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Accountant</span></h5>
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from accountant_log");
$cnt=1;
